...
| **206** | Success | Partial Content: server returns part of resource (range requests). |
| **300** | Redirection | Multiple Choices: multiple options for the resource. |
...
| **413** | Client Error | Payload Too Large: request entity too large. |
| **415** | Client Error | Unsupported Media Type: server refuses media type. |
